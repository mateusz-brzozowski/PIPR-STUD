...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy2.setHeightForWidth(self.only_best.sizePolicy().hasHeightForWidth())
        self.only_best.setSizePolicy(sizePolicy2)
        self.only_best.setLayoutDirection(Qt.LeftToRight)
        ...
        sizePolicy3.setHeightForWidth(self.max_date_select.sizePolicy().hasHeightForWidth())
        self.max_date_select.setSizePolicy(sizePolicy3)
        self.max_date_select.setAlignment(Qt.AlignCenter)
        self.max_date_select.setDateTime(QDateTime(QDate(2017, 12, 30), QTime(0, 0, 0)))
        ...
        self.gridLayout_2.addWidget(self.plot, 5, 0, 1, 3)

        self.min_date_select = QDateEdit(self.page_2)
        self.min_date_select.setObjectName(u"min_date_select")
        sizePolicy3.setHeightForWidth(self.min_date_select.sizePolicy().hasHeightForWidth())
        self.min_date_select.setSizePolicy(sizePolicy3)
        self.min_date_select.setLayoutDirection(Qt.LeftToRight)
